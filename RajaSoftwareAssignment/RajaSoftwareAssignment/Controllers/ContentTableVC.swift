...
class ContentTableVC: UITableViewController {
    ...
    /// Added to hide Navigation back bar button title
    func hideBackButtonTitle() {
        let leftNavBtn = UIBarButtonItem()
        leftNavBtn.title = ""
        self.navigationItem.backBarButtonItem = leftNavBtn
    }
